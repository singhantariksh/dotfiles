...
local options = {
	...
	save_directory = "~/Videos/mpv/", -- required for web videos
	...
	-- The default action
	action = "COPY",						-- the default action, ENCODE, ENCODE_GIF, COMPRESS or COPY

	-- File size targets
	compress_size = 10,					-- the target size for the COMPRESS action (in MB)

	-- encoding options
	encoding_type = "av1",					-- h264, h265, or av1
